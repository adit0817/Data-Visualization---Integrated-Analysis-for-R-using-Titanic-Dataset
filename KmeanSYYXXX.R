...
write.csv(titanic, file = "C:/Stuff/Study/Sem 2/Data Visualization/Assignments/Assignment 7/kmean/titanicNew.csv")
...
titanicNew<-read.csv("C:/Stuff/Study/Sem 2/Data Visualization/Assignments/Assignment 7/kmean/titanicNew.csv")
...
write.csv(titanicUpdated,file = "C:/Stuff/Study/Sem 2/Data Visualization/Assignments/Assignment 7/kmean/titanicUpdated.csv")
